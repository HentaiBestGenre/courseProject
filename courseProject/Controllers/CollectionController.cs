            ...
            if (ModelState.IsValid)
            {
                ...
                if (creater != null && topic != null)
                {
                    Collection newCollection = new Collection()
                    {
                        ...
                        TextFieldName1 = collection.TextFieldName1,
                        TextFieldName2 = collection.TextFieldName2,
                        TextFieldName3 = collection.TextFieldName3,
        ...
        public IActionResult CreateItem(CreateItemModel item)
        {
            if (ModelState.IsValid)
            {
                ...
                Item newItem = new Item()
                {
                    ...
                    TextFieldValue1 = item.TextFieldValue1,
                    TextFieldValue2 = item.TextFieldValue2,
                    TextFieldValue3 = item.TextFieldValue3,
