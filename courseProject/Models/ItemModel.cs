...
namespace courseProject.Models
{
    public class Item
    {
        ...
        [StringLength(50)] public string? StringFieldValue1 { get; set; }
        [StringLength(50)] public string? StringFieldValue2 { get; set; }
        [StringLength(50)] public string? StringFieldValue3 { get; set; }
